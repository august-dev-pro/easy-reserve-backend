...
const createService = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filePath = req.file ? path_1.default.relative(process.cwd(), req.file.path) : "";
    const cleanPath = filePath
        .replace(/^src[\\\/]uploads[\\\/]/, "") // Retire "src/uploads"
        .replace(/\\/g, "/"); // Remplace les \ par des /
    const serviceData = req.body;
    const serviceDatas = Object.assign(Object.assign({}, serviceData), { frontImage: cleanPath });
    try {
